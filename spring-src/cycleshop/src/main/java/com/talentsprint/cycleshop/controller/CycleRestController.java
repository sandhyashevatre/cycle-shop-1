...
public class CycleRestController {
    ...
    public ResponseEntity<List> removeFromCart( @PathVariable int id, @RequestParam int quantity) 
    {
        Authentication authentication = SecurityContextHolder.getContext().getAuthentication();
        String username = authentication.getName();
        List<Items> result = cartService.removeFromCart(id, quantity, username);
